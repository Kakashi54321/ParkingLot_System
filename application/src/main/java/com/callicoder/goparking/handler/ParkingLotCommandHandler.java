...
public class ParkingLotCommandHandler {
    ...
    public void park(String registrationNumber, String color) {
        ...
        Set<ParkingSlot> occupiedSlots = parkingLot.getOccupiedSlots();
    ...
    public void leave(int slotNo) {
    	 ...
    	 try {
    		 ParkingSlot slot = parkingLot.leaveSlot(slotNo);
    	 }catch(SlotNotFoundException ex) {
    		 System.out.println(ex.getMessage());
    	 }
    	 System.out.println(String.format( SLOT_NO_FREE, slotNo));
    }
